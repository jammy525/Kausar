                                        ...
                                        <tbody>
                                            ...
                                            foreach ($allProduct as $key => $value) {
                                                ...
                                                <tr id="c<?php echo $value['id']; ?>" data-block="false">
                                                    ...
                                                    <td><img width='200px' height="200px" src="<?php echo base_url()."control/upload/product/".$value['image']; ?>"></td>
                                                    <td><button type="button" class="btn btn-danger btn-xs" onclick="deletePackage(<?php echo $value['id']; ?>)"><i class="fa fa-ban"></i> Delete</button>
                                                        <a href="<?php echo base_url()."admin/product/edit/".$value['id']; ?>" type="button" class="btn btn-warning btn-xs"><i class="fa fa-pencil"></i> Edit</a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
