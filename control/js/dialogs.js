...
1) openWaitDialog( [Loading-text] );
		 ...
		 [Loading-text] is a text to be shown in the wait dialog.       Mandatory option
...
3) actionDialog(option);
    funcion used for open action dialog box . here are the options below :

	 option{         msg : "Text Message of Action",                              Mandatory option
	              action :  "pass function name to Perform action",               Mandatory option
	             success : true/false.  if ture Dialog is Success actionDialog    Default value : false
...
var dialogConfig = {
	id: 'dialog-amsparx',
	actionId : 'dialog-amsparx-action',
	yesActionId :'yes-amsparx-confirm',
	noActionId :'no-amsparx-confirm',
};
